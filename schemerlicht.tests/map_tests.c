...
static void test_map_4()
  ...
  TEST_EQ_INT(schemerlicht_object_type_undefined, obj20->type);
  TEST_EQ_INT(10, m->array_size);
  ...
  TEST_EQ_INT(schemerlicht_object_type_undefined, obj21->type);
  ...
  TEST_EQ_INT(schemerlicht_object_type_undefined, obj22->type);
  TEST_EQ_INT(0, m->array_size);
  TEST_EQ_INT(2, m->log_node_size);
  ...
  TEST_EQ_INT(schemerlicht_object_type_undefined, obj23->type);
  TEST_EQ_INT(0, m->array_size);
