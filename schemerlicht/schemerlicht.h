...
//#define SCHEMERLICHT_EXTENDED_INLINES
...
SCHEMERLICHT_API void schemerlicht_dump_compiled_program(schemerlicht_context* ctxt, schemerlicht_string* s, const char* script);
