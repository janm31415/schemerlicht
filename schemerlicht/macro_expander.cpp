...
namespace
  ...
  struct macro_finder_visitor : public VisitorBaseClass
    {
  ...
  struct macro_expander_visitor : public VisitorBaseClass
    {
    macro_data* p_md;
    context* p_ctxt;
...
#if 0
      uint64_t rbx = reg.rbx;
      uint64_t rdi = reg.rdi;
      uint64_t rsi = reg.rsi;
      uint64_t rsp = reg.rsp;
      uint64_t rbp = reg.rbp;
      uint64_t r12 = reg.r12;
      uint64_t r13 = reg.r13;
      uint64_t r14 = reg.r14;
      uint64_t r15 = reg.r15;
#endif
