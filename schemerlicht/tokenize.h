...
COMPILER_SCHEMERLICHT_API double to_double(const char* value);
COMPILER_SCHEMERLICHT_API int is_number(int* is_real, int* is_scientific, const char* value);
...
COMPILER_SCHEMERLICHT_API std::vector<token> tokenize(const std::string& str);
