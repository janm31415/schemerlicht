...
reg_alloc::reg_alloc(const std::vector<VM::vmcode::operand>& usable_registers, uint32_t number_of_locals) : available_registers(usable_registers),
...
VM::vmcode::operand reg_alloc::get_next_available_register()
  {
...
void reg_alloc::make_register_available(VM::vmcode::operand reg)
  {
...
bool reg_alloc::is_free_register(VM::vmcode::operand reg)
  {
...
void reg_alloc::make_register_unavailable(VM::vmcode::operand reg)
  {
